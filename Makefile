#####################################################################
#																	 
#	Created by u'nSP IDE V3.0.16.1		17:33:07	04/06/23
#
#####################################################################
...
INCLUDES	= -I"D:/Prj_GPCE3400/ZMM001A(EN)_MMMMMMM/soft/V46_asV34" -I"C:/Program Files (x86)/Generalplus/unSPIDE 3.0.16.1/library/include" -I"C:/Program Files (x86)/Generalplus/unSPIDE 3.0.16.1/library/include/sys" -I"D:/PRJ_GPCE4/SQ017A/soft/include" -I"../Include"
...
LDFLAGS	=  -blank 0x00 -initdata -infblk "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\GPCE3400A_Demo.inb" -conf "C:\Program Files (x86)\Generalplus\unSPIDE 3.0.16.1\Body\GPCE1_CE3\Checksum\GPCE1_CE3.cks"
...
OBJFILES	= \
	...
	"$(OUTDIR)\Rom_ZMM_V13_Pro_bin.res" \
	"$(OUTDIR)\main.obj" \
	"$(OUTDIR)\isr.obj" \
	"$(OUTDIR)\Resource.obj" \
...
"$(OUTDIR)\Rom_ZMM_V13_Pro_bin.res": "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\Rom\Link_Data\Rom_ZMM_V13_Pro.bin"
	$(RESC) "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\Rom\Link_Data\Rom_ZMM_V13_Pro.bin" "$(OUTDIR)\Rom_ZMM_V13_Pro_bin.res" RES_ROM_ZMM_V13_PRO_BIN 
...
"$(OUTDIR)\isr.obj": "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\isr.asm" ".\GPCE1_CE3.inc" ".\CTS_def.inc" ".\GPCE1_CE3_BODY.inc" "D:\PRJ_GPCE4\SQ017A\soft\include\A1800.inc" "..\Include\A3400Pro.inc" "..\Include\MS02.inc" 
...
"$(OUTDIR)\Algorithm.asm": "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\Algorithm.c" ".\Glob.h" ".\voice_A18.h" ".\GPCE1_CE3.h" ".\Led.h" ".\GPCE1_CE3_BODY.h" "D:\PRJ_GPCE4\SQ017A\soft\include\SACM.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
...
"$(OUTDIR)\Play_Speech.asm": "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\Play_Speech.c" ".\Glob.h" ".\voice_A18.h" ".\GPCE1_CE3.h" ".\GPCE1_CE3_BODY.h" "D:\PRJ_GPCE4\SQ017A\soft\include\SACM.h" 
	set PATH="$(APPDIR)\toolchain\";%PATH% & \
...
$(BINFILE) : $(OBJFILES) 
	...
	$(LD) $(BINTYPE) $(ARYFILE) "$(OUTDIR)\GPCE3400A_Demo_SPI.bin" -tskMaxUsed $(LDFLAGS) $(BODY) $(EXTRAFLAGS) -exportvalues "C:\Users\xdf\AppData\Local\Temp\ini7675.tmp" -defined "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\Debug\GlobalSymbol_GPCE1_CE3.ini" -bootrominfo "BootCode_SEC;0100" -undefined-opt __TgP190708CM -undefined-opt __TgP190708CL -undefined-opt __TgP190708M
	$(BOOTPACKER) "C:\Users\xdf\AppData\Local\Temp\ini7675.tmp"
	...
	$(LD) $(BINTYPE) $(ARYFILE) $(BINFILE) $(LDFLAGS) $(BODY) $(EXTRAFLAGS) -defined "D:\Prj_GPCE3400\ZMM001A(EN)_MMMMMMM\soft\V46_asV34\Debug\GlobalSymbol_GPCE1_CE3.ini" -bootrominfo "BootCode_SEC;0100" -undefined-opt __TgP190708CM -undefined-opt __TgP190708CL -undefined-opt __TgP190708M
